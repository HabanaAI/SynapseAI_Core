...
namespace gaudi2
{
class Gaudi2Device : public HWAbstractionLayer
{
public:
    Gaudi2Device() {}
    virtual ~Gaudi2Device() {}
    ...
    virtual unsigned    GetMonCfgRawVal(unsigned msbSid) const override;
    ...
    virtual bool isMmuEnabled() const override {return true;}
    virtual bool shouldConfigureMonCfg() const override {return true;}

private:
    Gaudi2Device(const Gaudi2Device& other) = delete;
    Gaudi2Device& operator=(const Gaudi2Device& other) = delete;
    ...
    static const unsigned   c_dmaCoreBlockOffset;
    static const unsigned   c_tpcCfgBlockOffset;

    static constexpr uint64_t GetSyncObjectAddress(int synObjIndex);
    int getAlignedFirstAvailableSOB() const;

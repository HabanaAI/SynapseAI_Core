...
// 8
#define FUNC_ID_FP32_CAST_2_FP16    0b001000
...
// 281
#define FUNC_ID_F32_LOG2_APPROX 0b100011001
// 282
#define FUNC_ID_REDUCTION_32 0b100011010
// 288
...
#define SPECIAL_FUNCS_CACHE_LINE_PADDING (CACHE_LINE_SIZE_IN_BYTES - (SPECIAL_FUNCS_NUM_OF_INTERVALS_IN_CACHE_LINE*SPECIAL_FUNC_BYTES_IN_ENTRY))
...
#define SPECIAL_FUNC256_SIZE_BYTES     ( SPECIAL_FUNCS_NUM_OF_CACHE_LINES_IN_FUNC_256 * CACHE_LINE_SIZE_IN_BYTES * SPECIAL_FUNC_NUM_TABLES_PER_TYPE )
#define SPECIAL_FUNC128_SIZE_BYTES     ( SPECIAL_FUNCS_NUM_OF_CACHE_LINES_IN_FUNC_128 * CACHE_LINE_SIZE_IN_BYTES * SPECIAL_FUNC_NUM_TABLES_PER_TYPE )
#define SPECIAL_FUNC64_SIZE_BYTES     ( SPECIAL_FUNCS_NUM_OF_CACHE_LINES_IN_FUNC_64  * CACHE_LINE_SIZE_IN_BYTES * SPECIAL_FUNC_NUM_TABLES_PER_TYPE )
#define SPECIAL_FUNC32_SIZE_BYTES     ( SPECIAL_FUNCS_NUM_OF_CACHE_LINES_IN_FUNC_32  * CACHE_LINE_SIZE_IN_BYTES * SPECIAL_FUNC_NUM_TABLES_PER_TYPE )

#define SPECIAL_FUNCS_BLOB_SIZE_BYTES ( \
        SPECIAL_FUNC256_SIZE_BYTES     +     \
        SPECIAL_FUNC128_SIZE_BYTES     +     \
        SPECIAL_FUNC64_SIZE_BYTES     +     \
        SPECIAL_FUNC32_SIZE_BYTES       )
#define SPECIAL_FUNCS_INTERVAL256_BASE_ADDR 0
#define SPECIAL_FUNCS_INTERVAL128_BASE_ADDR    (SPECIAL_FUNCS_INTERVAL256_BASE_ADDR     + (SPECIAL_FUNCS_NUM_OF_CACHE_LINES_IN_FUNC_256 * CACHE_LINE_SIZE_IN_BYTES * SPECIAL_FUNC_NUM_TABLES_PER_TYPE))
#define SPECIAL_FUNCS_INTERVAL64_BASE_ADDR     (SPECIAL_FUNCS_INTERVAL128_BASE_ADDR     + (SPECIAL_FUNCS_NUM_OF_CACHE_LINES_IN_FUNC_128 * CACHE_LINE_SIZE_IN_BYTES * SPECIAL_FUNC_NUM_TABLES_PER_TYPE))
#define SPECIAL_FUNCS_INTERVAL32_BASE_ADDR     (SPECIAL_FUNCS_INTERVAL64_BASE_ADDR     + (SPECIAL_FUNCS_NUM_OF_CACHE_LINES_IN_FUNC_64     * CACHE_LINE_SIZE_IN_BYTES * SPECIAL_FUNC_NUM_TABLES_PER_TYPE))
